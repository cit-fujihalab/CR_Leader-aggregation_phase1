...
def main():
	...
	global my_p2p_server_inner
	my_p2p_server_inner = ServerCore(HOST_PORT_LAYER_1_35) # note
	...
	my_p2p_server_outer = OwnerCore(HOST_PORT_LAYER_0_35, HOST_IP_LAYER_0, HOST_PORT_LAYER_0_origin)
	# my_p2p_server_outer = OwnerCore(50050, '10.0.2.15',50080)
