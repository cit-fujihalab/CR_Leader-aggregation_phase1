...
def main():
	...
	global my_p2p_server_inner
	my_p2p_server_inner = ServerCore(HOST_PORT_LAYER_1_3E) # note
	my_p2p_server_inner.start(crm = crossref)
	my_p2p_server_inner.join_network() 

	global my_p2p_server_outer
	my_p2p_server_outer = OwnerCore(HOST_PORT_LAYER_0_3E, HOST_IP_LAYER_0, HOST_PORT_LAYER_0_origin) # Dtop
