...
class MainWindow():
    ...
    def create_window1(self):
        ...
        t.geometry("400x300")
        l = tk.Label(t, text='履歴交差法information ', foreground='#ff0000', background='#ffaacc')
    ...
    def Break_node(self):
        ...
        t.wm_title("Create Info")
        t.geometry("400x300")
        l = tk.Label(t, text='ノードの故障させました。 ', foreground='#ff0000', background='#ffaacc')
        l.pack(side="top", fill="both", expand=True, padx=100, pady=100)
    ...
    def Revive_node(self):
        ...
        t.wm_title("Create Info")
        t.geometry("400x300")
        l = tk.Label(t, text='ノードの故障を復活させました。 ', foreground='#000000', background='#4169e1')
        l.pack(side="top", fill="both", expand=True, padx=100, pady=100)
        self.Break_state = False
        print("ノードの故障を復活させました。")

    def renew_block_state(self, block_P): #blockの更新
        print("blockの更新")
        self.block_state_P = block_P
    
    def renew_previous_cross_reference_block_state(self, block_C): #blockの更新
        print("previousの更新")
        self.block_state_C = block_C
    
    def renew_block_state(self, block_C): #blockの更新
        print("履歴交差部の確認")

    def renew_block_state(self, block_C): #内容の更新
        print("履歴交差部の確認")
