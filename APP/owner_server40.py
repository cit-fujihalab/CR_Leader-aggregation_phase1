...
from settings_connection import HOST_PORT_LAYER_0_10
...
def main():
	...
	global my_p2p_server_inner
	my_p2p_server_inner = ServerCore(HOST_PORT_LAYER_1_28) # note
	my_p2p_server_inner.start(crm = crossref)
	my_p2p_server_inner.join_network() 

	global my_p2p_server_outer
	my_p2p_server_outer = OwnerCore(HOST_PORT_LAYER_0_28, HOST_IP_LAYER_0, HOST_PORT_LAYER_0_origin)
