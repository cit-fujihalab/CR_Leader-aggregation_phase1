...
def main():
	...
	global my_p2p_server_inner
	my_p2p_server_inner = ServerCore(HOST_PORT_LAYER_1_37) # note
	...
	# my_p2p_server_outer = OwnerCore(50062, '10.84.242.82',50080)
	my_p2p_server_outer = OwnerCore(HOST_PORT_LAYER_0_37, HOST_IP_LAYER_0, HOST_PORT_LAYER_0_origin)
